...
export default class CenaUhrada extends Component {
  componentDidMount() {
    ...
    return (
      <Layout>
        <div className="container-fluid">
          <div className="row">
            <div className="col bg-gradient-dostupnost" style={leve}>
              <span>Cena a úhrada</span>
            </div>
            <div
              className="col"
              style={{ textAlign: "right", marginTop: "15px" }}
            >
              <Link id="sakraTohlA" to="/dostupnost" style={zavri}>
                x
              </Link>
            </div>
          </div>
